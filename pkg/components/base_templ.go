...
func base(title string, scripts ...templ.ComponentScript) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</title><script>\n\t\t\t\tif (localStorage.fitTheme === 'dark' || (!('fitTheme' in localStorage) && window.matchMedia('(prefers-color-scheme: dark)').matches)) {\n\t\t\t\t\tdocument.documentElement.classList.add('dark')\n\t\t\t\t\tlocalStorage.fitTheme = 'dark'\n\t\t\t\t} else {\n\t\t\t\t\tdocument.documentElement.classList.remove('dark')\n\t\t\t\t\tlocalStorage.fitTheme = 'light'\n\t\t\t\t}\n\t\t\t</script><script src=\"/js/htmx.min.js\"></script></head><body class=\"bg-white text-black dark:bg-gray-950 dark:text-white px-4\"><nav class=\"px-0 sm:px-4 py-4 flex justify-between\"><div class=\"flex items-center\"><img src=\"/img/logo.png\" alt=\"Logo\" width=\"80\" height=\"80\"></div><div class=\"flex space-x-4 md:space-x-6 items-center\"><div class=\"flex space-x-1 md:space-x-4\"><a class=\"text-sm hover:text-blue-400 dark:hover:text-blue-400 font-bold hidden md:block cursor-pointer\" hx-get=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
